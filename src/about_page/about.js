    ...
    return (
        <section className="about-page">
            <div className="about-page__what-is-vin">
                <h2>{ infoSection.block1.title }</h2>
                <p>{ infoSection.block1.description }</p>
            </div>
            <div className="about-page__how-to-find-vin">
                <h2>{ infoSection.block2.title }</h2>
                <p>{ infoSection.block2.description }</p>
            </div>
            <div className="about-page__why-vin-important">
                <h2>{ infoSection.block3.title }</h2>
                <p>{ infoSection.block3.description }</p>
            </div>
            <DescriptionList />
        </section>
    );
